...
module.exports = {
  ...
  // avg 是浮点数， 如果： randomIntByAvg(3.2)   返回值： 0.8的概率是3   0.2的概率是4
  randomByAvg(avg) {
    let c = Math.ceil(avg)
    return Math.random() < c - avg ? Math.floor(avg) : Math.ceil(avg)
  },
